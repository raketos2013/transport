                                ...
                                switch (newStep.OperationName)
                                {
                                    case OperationName.Copy:
                                        ...
                                        if (oldCopy != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newCopy.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Move:
                                        ...
                                        if (oldMove != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newMove.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Read:
                                        ...
                                        if (oldRead != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newRead.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Exist:
                                        ...
                                        if (oldExist != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newExist.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Rename:
                                        ...
                                        if (oldRename != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newRename.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Delete:
                                        ...
                                        if (oldDelete != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newDelete.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
                                    case OperationName.Clrbuf:
                                        ...
                                        if (oldClrbuf != null)
                                        {
                                            ...
                                            await unitOfWork.SaveAsync();
                                            newStep.OperationId = newClrbuf.OperationId;
                                            unitOfWork.StepRepository.EditStep(newStep);
                                            await unitOfWork.SaveAsync();
                                        }
                                        break;
