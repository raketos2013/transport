        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskId = table.Column<string>(type: "varchar(30)", nullable: false),
                    ...
                    OperationName = table.Column<string>(type: "varchar(20)", nullable: true),
                    ResultOperation = table.Column<int>(type: "integer", nullable: true),
                    FileName = table.Column<string>(type: "varchar(100)", nullable: true),
                    ResultText = table.Column<string>(type: "varchar(300)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileInLog = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddresseeGroupId = table.Column<int>(type: "integer", nullable: true),
                    AdditionalText = table.Column<string>(type: "text", nullable: true),
                    OldPattern = table.Column<string>(type: "text", nullable: false),
                    NewPattern = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
