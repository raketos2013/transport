...
namespace FileManager_Web.Controllers
{
	...
	public class UserLogsController : Controller
    {
		...
		public ActionResult Index(string dateFrom, string dateTo)
        {
            ...
            List<UserLogEntity> userLogs = _appDbContext.UserLogs.Where(x => x.DateTimeLog.Date >= date &&
        ...
        public ActionResult Details(string dateTime, string username)
        {
            ...
            UserLogEntity userLogs = _appDbContext.UserLogs.First(x => x.DateTimeLog == myDate && x.UserName == username);
